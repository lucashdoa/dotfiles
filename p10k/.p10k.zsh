# Generated by Powerlevel10k configuration wizard on 2025-07-22 at 20:08 -03.
...
() {
  ...
  #################################[ user ]##################################
  # User color.
  typeset -g POWERLEVEL9K_USER_FOREGROUND=#f9e2af
  ...
  # hide a tool, it gets shown  # Special note on the difference between POWERLEVEL9K_ASDF_SOURCES and
  ...
  #
  # Note: If this parameter is set to empty value, it won't 1 tools.
